...
fileprivate let smtp = SMTP(hostname: "smtp.163.com",     // SMTP server address
                            email: "xiaojie__zhao@163.com",     // username to login
                            password: "jxz520syz!")           // password to login


fileprivate let PUBGNewsBoxMailAddress = Mail.User(name: "PUBG新闻盒子", email: "763764553@qq.com")
/// check verify code
